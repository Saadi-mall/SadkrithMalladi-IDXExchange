...
fieldnames = ['OriginalListPrice','ListingKey','ListAgentEmail','CloseDate','ClosePrice',
'ListAgentFirstName','ListAgentLastName','Latitude','Longitude','UnparsedAddress','PropertyType',
'LivingArea','ListPrice','DaysOnMarket','ListOfficeName','BuyerOfficeName','CoListOfficeName',
...
for year, month in months:
    ...
    params = {
        ...
        '$filter': f"ListingContractDate ge {start} and ListingContractDate lt {end}",
        '$top': 1000
    }

    csv_file = f'CRMLSListing{year}{str(month).zfill(2)}.csv'
    total_records = 0
